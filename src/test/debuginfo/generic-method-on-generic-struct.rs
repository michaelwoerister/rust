...
// lldb-lldb-check:[...]$0 = Struct<(u32,i32)> { x: (8888, -8888) }
...
// STACK BY VAL
// lldb-command:print self
// lldb-lldb-check:[...]$3 = Struct<(u32,i32)> { x: (8888, -8888) }
// lldb-command:print arg1
// lldb-lldb-check:[...]$4 = -3
// lldb-command:print arg2
// lldb-lldb-check:[...]$5 = -4
...
// OWNED BY REF
// lldb-command:print *self
// lldb-lldb-check:[...]$6 = Struct<f64> { x: 1234.5 }
// lldb-command:print arg1
// lldb-lldb-check:[...]$7 = -5
// lldb-command:print arg2
// lldb-lldb-check:[...]$8 = -6
...
// OWNED BY VAL
// lldb-command:print self
// lldb-lldb-check:[...]$9 = Struct<f64> { x: 1234.5 }
// lldb-command:print arg1
...
// OWNED MOVED
// lldb-command:print *self
// lldb-lldb-check:[...]$12 = Struct<f64> { x: 1234.5 }
// lldb-command:print arg1
// lldb-lldb-check:[...]$13 = -9
// lldb-command:print arg2
// lldb-lldb-check:[...]$14 = -10.5
// lldb-command:continue
