...
// lldb-lldb-check:[...]$1 = 2.5
// lldb-command:print ret
// lldb-lldb-check:[...]$2 = ((1, 2.5), (2.5, 1))
// lldb-command:continue

// lldb-command:print *t0
// lldb-lldb-check:[...]$3 = 3.5
// lldb-command:print *t1
// lldb-lldb-check:[...]$4 = 4
// lldb-command:print ret
// lldb-lldb-check:[...]$5 = ((3.5, 4), (4, 3.5))
// lldb-command:continue

// lldb-command:print *t0
// lldb-lldb-check:[...]$6 = 5
// lldb-command:print *t1
// lldb-lldb-check:[...]$7 = Struct { a: 6, b: 7.5 }
// lldb-command:print ret
// lldb-lldb-check:[...]$8 = ((5, Struct { a: 6, b: 7.5 }), (Struct { a: 6, b: 7.5 }, 5))
// lldb-command:continue
