...
// lldb-lldb-check:[...]$0 = NoPadding1 { x: [0, 1, 2], y: -3, z: [4.5, 5.5] }
// lldb-command:print no_padding2
// lldb-lldb-check:[...]$1 = NoPadding2 { x: [6, 7, 8], y: [[9, 10], [11, 12]] }

// lldb-command:print struct_internal_padding
// lldb-lldb-check:[...]$2 = StructInternalPadding { x: [13, 14], y: [15, 16] }

// lldb-command:print single_vec
// lldb-lldb-check:[...]$3 = SingleVec { x: [17, 18, 19, 20, 21] }

// lldb-command:print struct_padded_at_end
// lldb-lldb-check:[...]$4 = StructPaddedAtEnd { x: [22, 23], y: [24, 25] }
