...
// regular C functions compiled with GCC or Clang and therefore are better handled by GDB. For LLDB
// this shouldn't make a difference because it can handle both cases.
