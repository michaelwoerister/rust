...
#[derive(Clone, PartialEq, Eq, Hash, Debug, RustcEncodable)]
...
#[derive(Clone, PartialEq, Eq, Hash, Copy, RustcEncodable)]
pub enum Region {
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, RustcEncodable)]
