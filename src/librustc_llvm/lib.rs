...
extern {
    ...
    /* Metadata */
    pub fn LLVMSetCurrentDebugLocation(Builder: BuilderRef, L: MetadataRef);
    pub fn LLVMGetCurrentDebugLocation(Builder: BuilderRef) -> MetadataRef;
    ...
    pub fn LLVMDICompositeTypeSetTypeArray(CompositeType: DIType, TypeArray: DIArray);
